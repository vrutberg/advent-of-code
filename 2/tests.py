...
class KeypadPositionTest(unittest.TestCase):
    ...
    def test_move_left_from_2(self):
        self.assertEqual(KeypadPosition(0, -1).move(Direction.left), KeypadPosition(-1, -1))

    def test_move_left_from_1(self):
        self.assertEqual(KeypadPosition(-1, -1).move(Direction.left), KeypadPosition(-1, -1))
